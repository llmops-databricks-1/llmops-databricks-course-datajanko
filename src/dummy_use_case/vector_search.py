"""Dummy vector search manager for testing orchestration with real VS endpoint."""
...
class DummyVectorSearchManager:
    """Full-protocol VS manager backed by real endpoint but using dummy data.

    Shares the same index and source table as LearningBuddyVectorSearchManager
    so the dummy processor's rows are immediately searchable.
