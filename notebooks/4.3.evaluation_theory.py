...
custom_results = mlflow.genai.evaluate(data=custom_test_data, scorers=[word_count_check, has_code_example, response_length_score])
...
sentiment_judge = make_judge(
    ...
    instructions=("Analyze the sentiment of the response in {{ outputs }}. Classify as: 'positive', 'neutral', or 'negative'"),
...
comprehensive_test_data = [
    {
        ...
        "outputs": (
            "Transformers are a neural network architecture that uses self-attention"
            " mechanisms to process sequential data. They've revolutionized NLP by"
            " enabling models like BERT and GPT."
        ),
    },
]
