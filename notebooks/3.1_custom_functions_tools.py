...
def search_papers(query: str, num_results: int = 5, year_filter: str = None) -> str:
    ...
    search_params = {"query_text": query, "columns": ["text", "title", "arxiv_id", "authors", "year"], "num_results": num_results, "query_type": "hybrid"}
    ...
    "function": {
        ...
        "parameters": {
            ...
            "properties": {
                ...
                "year_filter": {"type": "string", "description": "Optional year filter to limit results (e.g., '2024')"},
            },
            "required": ["query"],
        },
    },
...
class SimpleAgent:
    ...
    def __init__(self, llm_endpoint: str, system_prompt: str, tools: list[ToolInfo]):
        ...
        self._client = OpenAI(api_key=w.tokens.create(lifetime_seconds=1200).token_value, base_url=f"{w.config.host}/serving-endpoints")
