...
def function_with_metadata(x: int, y: int) -> int:
    ...
    mlflow.update_current_trace(
        ...
        tags={"model_serving_endpoint_name": "arxiv-agent-endpoint", "model_version": "1", "git_sha": git_sha, "request_type": "calculation"},
...
# Filter by tag
endpoint_traces = mlflow.search_traces(filter_string="tags.model_serving_endpoint_name = 'arxiv-agent-endpoint'", max_results=5)
